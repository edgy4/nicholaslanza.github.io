---
layout: single
title: 'Martini AD Writeup - Hack Smarter'
collection: writeups
author_profile: true
date: 2026-06-17
...
This write-up covers MartiniAD, a tricky, easy level, Active Directory machine from the Hack Smarter platform. This machine is currently one of the free offerings on their platform, and is great practice for AD. The primary attack chain highlights the dangers of careless credential storage and poor password hygiene. If you get stuck or have any questions while working through it, don’t hesitate to send me an email.
